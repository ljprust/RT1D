...
void riemann( struct cell * cL , struct cell * cR, double r , double dAdt ){
   ...
   prim2cons( primL , Ul_unboosted , 0.0 , 1.0 );
   prim2cons( primR , Ur_unboosted , 0.0 , 1.0 );
...
*/
   ...
   if( 0.0 < Sl ){
      ...
      // boost uFace back to lab frame
      double primFace[NUM_Q];
      cons2prim( uFace, primFace, 0.0, 1.0 );
      primFace[VRR] += w;
      prim2cons( primFace, uFace, 0.0, 1.0 );
   } 
